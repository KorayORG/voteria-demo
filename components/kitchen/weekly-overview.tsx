...
export function WeeklyOverview({ weekStatistics }: WeeklyOverviewProps) {
  if (!weekStatistics) {
    return (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
        {weekStatistics.days.map((day, index) => {
          const traditionalPercentage = Math.round(
            (day.traditional.votes / (day.traditional.votes + day.alternative.votes)) * 100,
          )
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xs text-gray-400 ml-1">(+{day.externalAdjustment.traditional})</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xs text-gray-400 ml-1">(+{day.externalAdjustment.alternative})</span>
                    </div>
                  </div>
                ...
                <div className="pt-3 border-t border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="text-center p-2 bg-orange-500/10 rounded">
                      <p className="text-orange-300 font-semibold">{day.finalCount.traditional}</p>
                      <p className="text-xs text-gray-400">Geleneksel</p>
                    </div>
                    <div className="text-center p-2 bg-green-500/10 rounded">
                      <p className="text-green-300 font-semibold">{day.finalCount.alternative}</p>
